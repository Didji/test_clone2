angular
    ...
    .factory("LicenseManager", function($location, $rootScope, $http, G3lic, i18n, Right, Utils, RIGHTS) {
        "use strict";
                ...
                case 0:
                    ...
                    if (license.offline_verification >= this.__offline_verification_block_threshold) {
                        ...
                        alertify.log(
                            i18n.get(
                                "_REGISTER_CAREFUL_",
                                this.__offline_verification_block_threshold - license.offline_verification
                            )
                        );
                    }
