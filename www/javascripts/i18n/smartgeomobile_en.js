...
window.smartgeo_i18n_lang.en = {
    ...
    _GPS_PERMISSION_DENIED_:
        "Application doesn't have permission to use the Location feature. Do you want to create your report anyway ?",
    ...
    _REPORT_IMG_MAX_SIZE_ALLOWED: "Max size allowed",
    _REPORT_IMG_CURRENT_SIZE: "Picture's current size",
    ...
    _REPORT_MEDIA: "Media",
    _REPORT_MEDIA_REQUIRED: "Please add a multimedia before saving you report.",
    ...
    _SYNC_CONFIRM_DELETE_ASSET_:
        "Are you sure to delete this asset ? This action is irreversible. The asset can not be recovered.",
    _INTENT_ZERO_SITE_SELECTED: "No site found",
    _INTENT_OBJECT_NOT_FOUND: "Object not found in database",
    _INTENT_AUTH_FAILED: "%s",
    _INTENT_ACTIVITY_NOT_FOUND_: "This activity doesn't exist.",
    _INTENT_ACTIVITY_NOT_COMPATIBLE_: "Activity not compatible. Type different from 'multi_assets_tour'",
    _INTENT_NOT_AVAILABLE_: "This intent is not available.",
    _INTENT_NOT_VALID_: "This activity is not compatible or incorrect.",
    ...
    _PROJECTS_LOADED_PROJECT_NOT_SAVE_:
        "Current loaded project has been modified, please save or drop changes before unload",
