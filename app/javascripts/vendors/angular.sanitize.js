...
(function(q, g, r) {
    'use strict';
    function F(a) {
        var d = [];t( d, g.noop ).chars( a );return d.join( "" );
    }
    function m(a) {
        var d = {};
        a = a.split( "," );var c;
    ...
    function G(a, d) {
        function c(a, b, c, h) {
            ...
            w[b] && f.last() == b && e( "", b );(h = x[b] || !!h) || f.push( b );var n = {};c.replace( H, function(a, b, d, c, e) {
                n[b] = s( d || c || e || "" );
        ...
        "string" !== typeof a && (a = null === a || "undefined" === typeof a ? "" : "" + a);var b, l,
            f = [],
            n = a, h;
        for (f.last = function() {
                return f[f.length - 1];
            ...
            if (f.last() && y[f.last()]) {
                a = a.replace( new RegExp( "(.*)<\\s*\\/\\s*" + f.last() + "[^>]*>", "i" ), function(a, b) {
                    b = b.replace( I, "$1" ).replace( J, "$1" );d.chars && d.chars( s( b ) );return "";
                } ), e( "", f.last() );
            } else {
                if (0 === a.indexOf( "\x3c!--" )) {
    ...
    function C(a) {
        return a.replace( /&/g, "&amp;" ).replace( O, function(a) {
            ...
            a = a.charCodeAt( 1 );return "&#" + (1024 * (c - 55296) + (a - 56320) + 65536) + ";";
