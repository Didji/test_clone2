 ...
 */
    ...
    */
    ...
    // window.navigator.app = { exitApp : function(){
    //     $("*").empty();
    //     return
    // }};

    // window.navigator.notification = {
    //     confirm: function(text, callback, title, button) {
    //         callback(confirm(text) === true ? 1 : 2);
    //     },

    //     alert: function(text, callback, title, button) {
    //         alert(text);
    //         callback();
    //     },

    //     prompt: function(text, callback, title, button) {
